...
export class AppComponent {
  ...
  // }
  //
  //  StartDropDownAnimationSimple(el, amount, onAnimationEnd){
  //   if(amount > 0){
  ...
  // }
  //
  //  StartDropDownAnimation(el, amount, startOffset, goalOffset, onAnimationEnd){
  ...
  // }
  //
  //  SetActivePlayerAndPitsToValid(gameState){
  ...
  // }
  //
  //  IfTrueAddElseRemoveClass(element, className, condition){
  //   if(condition){
